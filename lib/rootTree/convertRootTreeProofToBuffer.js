const BufferWriter = require('@xazab/xazabcore-lib/lib/encoding/bufferwriter');
const { convertBitArrayToUInt8Array } = require('@xazab/xazabcore-lib/lib/util/bitarray');
