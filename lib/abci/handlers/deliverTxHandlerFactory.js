...
const stateTransitionTypes = require('@xazab/dpp/lib/stateTransition/stateTransitionTypes');
const AbstractDocumentTransition = require(
  '@xazab/dpp/lib/document/stateTransition/documentTransition/AbstractDocumentTransition',
);
 ...
 * @param {XazabPlatformProtocol} transactionalDpp
